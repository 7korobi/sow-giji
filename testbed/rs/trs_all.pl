...
'<p>あなたは<A href="http://crazy-crazy.sakura.ne.jp/giji/?(Role)ROLEID_TANGLE" TARGET="_blank">怨念</A>です。<br>毎夜、死者の埋葬地をうろつきまわっています。もしあなたが命を落とすと、その夜に指定した故人の役職と勝利条件を写しとり、対象を蘇生させます。このため、あなたは死亡しなくては、勝利がありません。未実装です。</p>',
'<p>あなたは、未定義の役職です。</p>',
