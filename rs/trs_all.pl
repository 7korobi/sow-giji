...
sub GetTextRS {
	...
	my %role_win = (
	 ...
	 # イベント名
	 my @eventname = (
		  '', '普通の日', '四月馬鹿', '二重スパイ', '妖精の輪', '日蝕' , 'Sir Cointoss', '影響力', '奇跡', '聖者のお告げ',
		  '', '不満'    , '熱意'    , '悪夢'      , '亡霊'    , ''     , '降霊会'      , ''      , ''    , ''            ,
	 );
...
'未定義のイベントです。',
	...
	# アイテム名
	my @giftname = (
		'おまかせ',  'なし',  '喪失',  '感染',  '','光の輪', '魔鏡', '悪鬼', '妖精の子', '半端者',
		''        ,'決定者','夢占師','酔払い',  '',      '',     '',     '',         '',       '',
	);
	...
	# 役職名
	my @rolename = (
		'おまかせ', '村人'      , '聖痕者'    ,   '結社員'  , '共鳴者'  , '占い師'  , '信仰占師', '気占師'  , '賢者'    , '守護者'  ,
		...
		''        , ''          , ''          ,   ''        , ''        , ''        , ''        , ''        , ''        , ''        ,
		''        , '栗鼠妖精'  , ''          ,   '蝙蝠妖精', ''        , ''        , '擬狼妖精', ''        , '風花妖精', '悪戯妖精',
		'邪気悪魔', '恋愛天使'  , '片想い'    ,   '弟子'    , '盗賊'    , ''        , '一匹狼'  , '笛吹き'  , '鱗魚人'  , '悪魔くん',
		'無魂屍'  , '遊び人'    , '吸血竜'    ,   ''        , '見習い'  , ''        , ''        , ''        , ''        , ''        ,
	);
	...
	my @abi_role = (
		...
		''    ,''    ,''    ,''    ,''        ,''        ,''      ,''      ,''      ,''    ,   
		''    ,''    ,''    ,''    ,''        ,''        ,''      ,''      ,''      ,'結ぶ',   
		'結ぶ','結ぶ','結ぶ','入門',''        ,''        ,'襲う'  ,'誘う'  ,'跳ねる',''    ,
		''    ,'遊ぶ','吸血',''    ,''        ,''        ,''      ,''      ,''      ,''    ,   
	);

	# 説明
	my $stat_kill   = '殺害します。ただし、対象が護衛されているか、光の輪を渡されているか、妖精、もしくは一匹狼であれば、効力は発揮しません。また、対象が半狼であれば彼は人狼になり、人犬、もしくは無傷の長老の場合は、即死はしませんが傷を負わせることができます。';
	my $stat_wolf   = '毎夜、人狼全員で一人だけ、村人を'.$stat_kill.'<br>';
	my $stat_wisper = '人狼（と囁き狂人、擬狼妖精）同士にしか聞こえない会話が可能です。<br>';
	my $stat_pixi   = '狼の襲撃や賞金稼の手により殺されることはありません。ただし占いの対象となると死亡します。<br>占い師、霊能者には人間として判別されますが、勝利判定では人間にも人狼にも数えられません。<br>';
	my $stat_enemy  = '人間でありながら、人外に協力する裏切り者です。終了条件では人間扱いで集計されるため、場合によっては敢えて死ぬ必要があります。';
	my $stat_fm     = '自分以外の結社員・共鳴者が誰か知っています。';
	my $act_seer    = '毎夜ひとりを占い、その人が';
	my $act_medium  = '無惨な死体について判断することは出来ません。処刑や突然死で死んだ者が';
	my $stat_seer   = 'また、妖精を占うと呪殺します。ただし、呪人、呪狼を占ってしまうと、呪殺されてしまいます。邪魔之民に包み隠された相手を占うと、占いを実施しなかったことになり、結果を得たり、呪殺したりといった効能が得られません。';
	my $know_seer   = '人間か人狼か判別できます。ただし狼血族は人狼と誤認し、白狼は人間と誤認してしまいます。';
	my $know_wisdom = '持つ役職がわかります。恩恵は、役職とは別個のものです。このため半端者、悪鬼、妖精の子を直接見分けることはできません。';
	my $know_win    = '持つ陣営（勝利条件）がわかります。多くは役職を思わせるものです。';
	my $stat_droop  = 'あなたは、生きた人狼の人数の二日後に、命を落とします。';
	my $stat_suicide = '“運命の絆”を結んだ人は、片方が死亡すると後を追って死亡します。';
	my $stat_devil   = '一日目、好きな二人に“運命の絆”を結びつける事ができます。運命は彼らに、悲しい殺し合いを強いるでしょう。';
	my $stat_angel   = '一日目、好きな二人に“運命の絆”を結びつける事ができます。'.$stat_suicide;
	my $stat_cycle  = 'どんな理由であれ命を落とすと';
	my $stat_other  = 'あなたは、勝利判定では人間として数えられます。';
	my $stat_gift   = 'ふたたびあなたの手に渡ったら消え去ってしまいます。';
...
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Gift)GIFTID_DIPSY" TARGET="_blank">酔払い</A>です。<br>あなたが人外もしくは村人に相対するものであれば、自分の役割を見失うことはありません。<br>また、光の輪や魔鏡といった贈り物を受け取った場合、酔いが醒めることでしょう。</p>',
'',
'',
'',
'',
...
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_FM" TARGET="_blank">結社員</A>です。<br>独自の人脈を持つ秘密結社の一員です。'.$stat_fm.'</p>',
...
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_AURA" TARGET="_blank">気（オーラ）占い師</A>です。<br>'.$act_seer.'能力を持つか判別出来ます。あなたにとって、村人、人狼、白狼は能力のオーラを持ちませんが、そうでない人物は能力のオーラを纏っていると感じられます。<br>'.$stat_seer.'</p>',
...
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_GUARD" TARGET="_blank">守護者</A>です。<br>毎夜、一人を狼の襲撃、もしくは付け狙う賞金稼の手から守ることが出来ます。<br>自分自身を守ることは出来ません。</p>',

'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_MEDIUM" TARGET="_blank">霊能者</A>です。<br>'.$act_medium.$know_seer.'</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_MEDIUMWIN" TARGET="_blank">信仰霊能者</A>です。<br>'.$act_medium.$know_win.'</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_MEDIUMROLE" TARGET="_blank">導師</A>です。<br>'.$act_medium.$know_wisdom.'</p>',
...
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_FOLLOW" TARGET="_blank">追従者</A>です。<br>あなたは投票を委任することしかできません。だれかを信じ、委ねましょう。</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_FAN" TARGET="_blank">煽動者</A>です。<br>あなたが'.$stat_cycle.'、翌日は、村人達が暴力的に二つの投票をおこない、二人を一度に処刑します。</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_HUNTER" TARGET="_blank">賞金稼</A>です。<br>毎夜、一人を付け狙います。<br>あなたが、'.$stat_cycle.'、あなたは付け狙っていた人物を道連れに、'.$stat_kill.'</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_WEREDOG" TARGET="_blank">人犬</A>です。<br>あなたは狼の襲撃を受ける、もしくは賞金稼に道連れにされると傷を負うものの、一日だけ生き長らえます。</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_PRINCE" TARGET="_blank">王子様</A>です。<br>あなたが処刑されることに決まると一度だけは、その処刑はとりやめになります。</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_VILLAGER" TARGET="_blank">村人</A>です。<br>特殊な能力はもっていません。</p>',

'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_DOCTOR" TARGET="_blank">医師</A>です。<br>毎夜ひとりを診察し、人狼の牙に感染しているかを確認します。その場合は治療します。治療した人は生存者として数えますが、能力は取り戻しません。<br>'.$stat_seer.'</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_CURSE" TARGET="_blank">呪人</A>です。<br>あなたを占ってしまった占い師は死亡します。</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_DYING" TARGET="_blank">預言者</A>です。<br>'.$stat_droop.'</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_INVALID" TARGET="_blank">病人</A>です。<br>あなたが命を落としたとき、ひとりの犯人が特定できるのであれば、犯人は病気に感染し、いっさいの能力を行使できなくなります。</p>',
...
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_GIRL" TARGET="_blank">少女</A>です。<br>あなたは二日目以降、夜に出歩くことができます。人狼の囁き、民の念話、共鳴者の共鳴を誰のものとも判別せず聞いちゃうので、朝になって昨日を振り返ると思い出せることでしょう。顔や名前はわかりませんが。<br>ただしこのとき、もしあなたが人狼の、誰かひとりにでも襲撃される矛先に含まれていると、恐怖のあまり、実際に襲われる犠牲者とは別に死んでしまいます。この死亡を護衛する方法はありません。また、息を引き取るあなたを尻目に、狼達は別の人物を襲撃するでしょう。</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_SCAPEGOAT" TARGET="_blank">生贄</A>です。<br>もし投票数が同数になり処刑する相手が定まらないと、混乱した村人達に処刑されてしまいます。あなたが最後に指差した人は、後悔する村人達に翌日、処刑されるでしょう。皆、そうするより他にないのです。</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_ELDER" TARGET="_blank">長老</A>です。<br>あなたは狼の襲撃を受ける、もしくは賞金稼に道連れにされても、一度だけは命が助かります。もしも夜に、それでも命を落としたら、あなたの恨みは犯人を襲います。ひとりの犯人が特定できるのであれば、犯人は特殊能力を失います。</p>',
'<p>あなたは疫病神ですが、無能です。いまのところ実装する予定はありません。</p>',

'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_JAMMER" TARGET="_blank">邪魔之民</A>です。<br>毎夜、一人をあらゆる占いから包み隠すことができます。<br>自分自身を隠すことはできません。<br>また、念波星でしか聞こえない会話が可能です。<br>'.$stat_enemy.'</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_SNATCH" TARGET="_blank">宿借之民</A>です。<br>好きな人物の顔と名前を奪い、自身のそれと入れ替えることができます。この能力は非常に露顕しやすいので、行使には注意が必要です。<br>もしも夜の間に屍体になった人を対象に選んだなら、旧いあなたは命を落とし、あなたとなったその屍体は息を吹き返すでしょう。また、結ばれた絆や、笛吹きに誘われたことは姿とともにあり、姿を移し替えたときに引き継ぐことがあります。一度移し替えた姿は、永遠にあなたのものです。二度と元には戻りません。<br>また、念波星でしか聞こえない会話が可能です。<br>'.$stat_enemy.'</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_BAT" TARGET="_blank">念波之民</A>です。<br>念波星でしか聞こえない会話が可能です。<br>'.$stat_enemy.'</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは封印狂人ですが、無能です。いまのところ実装する予定はありません。</p>',
'<p>あなたは悟られ狂人ですが、無能です。いまのところ実装する予定はありません。</p>',
...
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_MUPPETER" TARGET="_blank">人形使い</A>です。<br>あなたは<b>_NPC_</b>の口を借り、好きな言葉を伝えることができます。<br>'.$stat_enemy.'</p>',
...
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_SEMIWOLF" TARGET="_blank">半狼</A>です。<br>あなたは狼の襲撃を受ける、もしくは賞金稼に道連れにされると、あなたは人狼になります。<br>'.$stat_enemy.'</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_ORACLE" TARGET="_blank">魔神官</A>です。<br>'.$act_medium.$know_wisdom.'<br>'.$stat_enemy.'</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_SORCERER" TARGET="_blank">魔術師</A>です。<br>'.$act_seer.$know_wisdom.'<br>'.$stat_seer.'<br>'.$stat_enemy.'</p>',
'<p>あなたは、未定義の役職です。</p>',
...
'<p>あなたは憑狼ですが、無能です。いまのところ実装する予定はありません。</p>',
...
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_WHITEWOLF" TARGET="_blank">白狼</A>です。特殊な能力を持つ人狼です。<br>あなたを占った占い師は、あなたを人間とみなします。あなたは能力者特有のオーラを発しません。<br>'.$stat_wolf.'また、'.$stat_wisper.'</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_CHILDWOLF" TARGET="_blank">仔狼</A>です。特殊な能力を持つ人狼です。<br>あなたが命を落とした翌日、人狼は二つの襲撃をおこない、二人を一度に殺害します。<br>'.$stat_wolf.'また、'.$stat_wisper.'</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_DYINGWOLF" TARGET="_blank">衰狼</A>です。特殊な能力を持つ人狼です。<br>'.$stat_droop.$stat_wolf.'また、'.$stat_wisper.'</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_SILENTWOLF" TARGET="_blank">黙狼</A>です。<br>'.$stat_wolf.'人狼の襲撃対象となることはありませんが、人狼（と囁き狂人、擬狼妖精）同士にしか聞こえない会話は、あなたには聞こえません。</p>',
'<p>あなたは、未定義の役職です。</p>',
...
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_PIXI" TARGET="_blank">栗鼠妖精</A>です。<br>'.$stat_pixi.'</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_BAT" TARGET="_blank">蝙蝠妖精</A>です。<br>あなたは他の妖精が誰であるか知っていますし、新たに生まれた妖精を知ることもできます。ただし、姿を換えてしまった宿借妖精の行方はわかりません。<br>また、蝙蝠妖精同士にしか聞こえない会話が可能です。<br>'.$stat_pixi.'</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_MIMICRY" TARGET="_blank">擬狼妖精</A>です。<br>あなたは参加できませんが、'.$stat_wolf.'<br>あなたは妖精でありながら、'.$stat_wisper.$stat_pixi.'</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_DYINGPIXI" TARGET="_blank">風花妖精</A>です。<br>あなたは、生きた人狼の人数の二日後に、命を落とします。<br>'.$stat_pixi.'</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_TRICKSTER" TARGET="_blank">悪戯妖精</A>です。<br>悪戯妖精は'.$stat_pixi.$stat_angel.'結ばれた彼らにとっては、単なるはた迷惑な悪戯にすぎません。</p>',

'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_HATEDEVIL" TARGET="_blank">邪気悪魔</A>です。<br>邪気悪魔は'.$stat_devil.'<br>結びつけた二人のうち、どちらか片方だけが生き延びれば、あなたの勝利となります。あなたにその絆が結ばれていない限り、あなた自身の死は勝敗には直接関係しません。<br>また、'.$stat_other.'</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_LOVEANGEL" TARGET="_blank">恋愛天使</A>です。<br>恋愛天使は'.$stat_angel.'<br>結びつけた二人が生き延びれば、あなたの勝利となります。あなたにその絆が結ばれていない限り、あなた自身の死は勝敗には直接関係しません。<br>また、'.$stat_other.'</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_PASSION" TARGET="_blank">片想い</A>です。<br>一日目に好きな相手を選び、一方的に縁を結びます。<br>選んだ人が生き延び、あなたが生き延びれば、あなたの勝利となります。<br>また、'.$stat_other.'</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_LOVER" TARGET="_blank">弟子</A>です。<br>一日目、好きな人物を師匠として選び、“運命の絆”を結びつけ、弟子入りします。次の朝、あなたは頭角をあらわし、絆の師匠と同じ役職になっています。<br>“運命の絆”を結んだ二人は、片方が死亡すると後を追って死亡します。</p>',
...
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_LONEWOLF" TARGET="_blank">一匹狼</A>です。<br>人狼ですが、他の人狼とは別個に'.$stat_kill.'<br>また、襲撃先はあなた以外であれば誰でもかまわず、あなた自身は、狼の襲撃や賞金稼の手により殺されることはありません。</p>',
...
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_DISH" TARGET="_blank">鱗魚人</A>です。新鮮なふぃーっしゅ。です。<br>美味しく食べて貰うことを悦びとし、活き活きと跳ねることができます。わたしをたべて、わたしをたべて、とアピールしましょう。<br>また、'.$stat_other.'</p>',
'<p>あなたは悪魔くんですが、無能です。いまのところ実装する予定はありません。</p>',

'<p>あなたは無魂屍ですが、無能です。いまのところ実装する予定はありません。</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_BITCH" TARGET="_blank">遊び人</A>です。<br>一日目、一人目に選択した人物を本命の恋人として“運命の絆”を結びつけ、二人目は絆を結ぶふりをして手玉にとります。'.$stat_suicide.'本命とあなたが生き延びれば、あなたの勝利となります。もう一人はどうでもよいのですが、そう思わせないこまめなケアが大切です。</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは見習いですが、無能です。いまのところ実装する予定はありません。</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは、未定義の役職です。</p>',
	...
	my %textrs = (
		...
		EXECUTEBITCH    => '<b>_NAME_</b>は<b>_TARGET1_</b>と絆を結び、<b>_TARGET2_</b>を手玉にとった。',
		...
		RESULT_BITCH    => '<b>_DATE_日目</b>の夜、<b>_TARGET1_</b>と絆を結び、<b>_TARGET2_</b>を手玉にとった。',
		...
		WIN_HATER       => '<b><A href="http://dais.kokage.cc/guide/?(Text)WIN_HATER" TARGET="_blank">邪気陣営</A></b><br>いずこかの陣営が勝利を手にしたとき、運命に決着をつけていれば勝利します。決着とは、絆の天敵をすべて倒し、一人だけが生き残っていることです。殺し合いの絆を断ち切りましょう。絆の相手が死んでも、後を追うことはありません。<br>絆の天敵とは、たとえあなた自身には関係のなくとも、あらゆる絆を結んでいるもの全てを指します。',
		WIN_DISH        => '<b><A href="http://dais.kokage.cc/guide/?(Text)WIN_DISH" TARGET="_blank">据え膳</A></b><br>すべてに決着がついたとき、あなたが狼の襲撃、もしくは賞金稼の道連れにより死亡していれば、勝利者の一員に加わります。',
