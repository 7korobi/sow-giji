...
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Gift)GIFTID_FAIRY" TARGET="_blank">妖精から生まれた子</A>です。<br>表向きは他の役目を帯びていますが、あなたは人ならぬ存在なのです。<br>狼の襲撃や賞金稼の手により殺されることはありません。ただし占いの対象となると死亡します。<br>占い師、霊能者にどう判別されるかは、もともとの役職によります。勝利条件では人間にも人狼にも数えられません。</p>',
'',
...
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_PIXI" TARGET="_blank">妖精</A>です。<br>'.$stat_pixi.'</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは、未定義の役職です。</p>',
...
'<p>あなたは<A hr//dais.kokage.cc/guide/.jp/giji/?(Role)ROLEID_GURU" TARGET="_blank">教祖</A>です。<br>教祖は毎晩ふたりずつ、好きな人物をひそかに誘い込むことができます。自分自身を誘うことはできません。<br>誘い込まれた当人たちは信者となって夜な夜な宗教儀式に耽り、そのことを覚えています。しかし、彼らの能力や所属陣営などに変化はありません。<br>また、'.$stat_other.'</p>',
'<p>あなたは、未定義の役職です。</p>',
'<p>あなたは、未定義の役職です。</p>',
   );
