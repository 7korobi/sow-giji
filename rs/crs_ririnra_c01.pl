...
sub GetRSChr {
  ...
  # ダミーキャラの発言
  my @npcsay =(
    "あの日に絵本をもらってから、王子様との逢瀬を夢見ては書き溜めていた。<br>レナータが捕まえた佳い人もまあまあだけれど、私だけの王子様はきっと桃園のにあうひと。<br><br>ゼラニウムをヤドリギで繋げた花飾り、明日はどこに持っていこう？",
    "ごめんね、本物の恋がしたくなっちゃった。<br><br>ふたりだけの記念日に待ち合わせ<br>聖祝日の夕焼けに頬を染めて見つめ合い<br>歌劇酒場の名優が、君と生きていく明日を歌い上げるよりもなお雄弁に<br><br>花飾りに隙間をあけて、今日はツツジを添えました。",
  );
